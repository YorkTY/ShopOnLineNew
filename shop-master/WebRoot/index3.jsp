 ...
 <a href="#">彩宝</a> <a href="#">银饰</a> <a href="#">坦桑石</a> <a href="#">世嘉</a> <a href="#">一搏千金</a> <a href="#">荔尚</a> <a href="#">金大生</a> <a href="#">黛米</a> <a href="#">IDEAL</a><a href="#">念玉珠宝</a> <a href="#">七彩云南</a><a href="#">玉礼</a>
    ...
    <div class="cont">
     ...
     <div class="list-selector">
        <h2 class="_header">查询匹配的产品<small> - 商品筛选</small></h2>
        <div class="_body">
            <dl class="_item">
                <dt>品牌：</dt>
                <dd>
        ...
        <div class="_body">
            <dl class="_item">
                <dt>价格：</dt>
                <dd>
                    <a href="product_getSearchProduct3.action?min_price=1&max_price=100000"  class="active">不限</a>
                            <a href="product_getSearchProduct3.action?min_price=1&max_price=200">1-200</a>
                            <a href="product_getSearchProduct3.action?min_price=200&max_price=1000" >200-1000</a>
                            <a href="product_getSearchProduct3.action?min_price=1000&max_price=100000" >1000+</a>
                </dd>
            </dl>
        </div>
    </div>
