...
<html>
  ...
  <body class="easyui-layout">   
    ...
    <div data-options="region:'north',title:'欢迎来到易购后台管理系统',split:true" style="height:100px;"><a href="index0.jsp" style="color: red; margin-left:20px;">返回商城首页</a><a href="account_quit.action" style="margin-left:50px;color: red;">退出登录</a></div> 
