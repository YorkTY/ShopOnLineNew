...
<div class="row">
 ...
 <a href="#">彩宝</a> <a href="#">银饰</a> <a href="#">坦桑石</a> <a href="#">世嘉</a> <a href="#">一搏千金</a> <a href="#">荔尚</a> <a href="#">金大生</a> <a href="#">黛米</a> <a href="#">IDEAL</a><a href="#">念玉珠宝</a> <a href="#">七彩云南</a><a href="#">玉礼</a>
    ...
    <div class="cont">
     <div class="breadcrumb">
        ...
        <span>&nbsp;&gt;&nbsp;<a href="#">内地国产</a>&nbsp;&gt;&nbsp;<a href="#">${sessionScope.result.dataList[0].category.type }</a></span>
    </div>
     <div class="list-selector">
        <h2 class="_header">${sessionScope.result.dataList[0].category.type }<small> - 商品筛选</small></h2>
        <div class="_body">
            <dl class="_item">
                <dt>品牌：</dt>
                <dd>
        ...
        <div class="_body">
            <dl class="_item">
                <dt>价格：</dt>
                <dd>
                    <a href="/shop/category_listProduct.action?id=3&min_price=1&max_price=100000"  class="active">不限</a>
                            <a href="/shop/category_listProduct.action?id=${sessionScope.result.dataList[0].category.id}&min_price=1&max_price=200" >1-200</a>
                            <a href="/shop/category_listProduct.action?id=${sessionScope.result.dataList[0].category.id}&min_price=200&max_price=1000" >200-1000</a>
                            <a href="/shop/category_listProduct.action?id=${sessionScope.result.dataList[0].category.id}&min_price=1000&max_price=100000" >1000+</a>
                </dd>
            </dl>
        </div>
    </div>
    <div class="list-filter">
        <div class="_sort">
            <a href="/list/77.html?brandId=0&amp;filterPrice=0&amp;sortColumn=0&amp;sortDirection=1&amp;page=1" class=" active  _down">默认</a>
            <a href="/list/77.html?brandId=0&amp;filterPrice=0&amp;sortColumn=1&amp;sortDirection=1&amp;page=1" class=" ">价格</a>
            <a href="/list/77.html?brandId=0&amp;filterPrice=0&amp;sortColumn=2&amp;sortDirection=1&amp;page=1" class=" ">评价</a>
            <a href="/list/77.html?brandId=0&amp;filterPrice=0&amp;sortColumn=4&amp;sortDirection=1&amp;page=1" class=" ">人气</a>
        </div>
        <div class="_pager">
            <span class="_text"><b>1</b><em>/</em><i>1</i></span>
                <a class="_prev disabled" href="javascript:;">&lt;</a>
                            <a class="_next disabled" href="javascript:;">&gt;</a>
        </div>
    </div>
    </div>
 <div class="list-goods">
        ...
        <div class="inner">      
        <div class="_img">      
        <a href="/shop/product_get.action?id=${product.id}&typeid=${product.category.id}" ><img src="images/${product.pic}" width="230" height="230"></a>
        <a href="#" class="_focus"><i class="iconfont">&#xe60d;</i>收藏</a>
        </div>
        <div class="_price">
        <strong><small>￥</small><i>${product.price }</i></strong>
        </div>
        <div class="_name">
        <a href="#">${product.name }</a></div>
        <div class="_commit">
        <strong>已有<a href="#">0</a>人评价</strong>
        </div>
        <div class="_shop">
        <a href="#">货品发布员</a>
        </div>           
        ...
        <div class="inner">
        <div class="_img">
        <a href="#" ><img src="images/g2.jpg" width="230" height="230"></a>
        <a href="#" class="_focus"><i class="iconfont">&#xe60d;</i>收藏</a>
        </div>
        <div class="_price">
        ...
        <div class="_name">
        <a href="#">临朐大棚樱桃大樱桃车厘子新鲜水果红灯</a></div>
        <div class="_commit">
        <strong>已有<a href="#">0</a>人评价</strong>
        </div>
        <div class="_shop">
        ...
        <div class="inner">
        <div class="_img">
        <a href="#" ><img src="images/g3.jpg" width="230" height="230"></a>
        <a href="#" class="_focus"><i class="iconfont">&#xe60d;</i>收藏</a>
        </div>
        <div class="_price">
        <strong><small>￥</small><i>130.00</i></strong>
        ...
        <li class="_item">
         <div class="inner">
        <div class="_img">
        <a href="#" ><img src="images/g4.jpg" width="230" height="230"></a>
        <a href="#" class="_focus"><i class="iconfont">&#xe60d;</i>收藏</a>
        </div>
        <div class="_price">
        <strong><small>￥</small><i>130.00</i></strong>
