...
<link rel="stylesheet" type="text/css" href="css/personal6.css">
...
<div class="row">
 ...
 <div class="ucenter-content">
                <h2 class="ucenter-title pull-left">个人信息</h2>
                <form name="userInfoForm" action="user_saveUser.action" method="post" id="action">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="member-table">
                    <tbody>
                    <tr>
                    <input class="pull-left" type="hidden" id="id" name="id" value="${sessionScope.user.id }"/>  
                    </tr>
                        <tr>
                            <th width="100" align="right" >用户名：</th>
                            <td class="pull-left">
                                    <input type="text" name="name" value="${sessionScope.user.name }" class="text" style="width:200px" />
                                &nbsp;&nbsp;&nbsp;注册会员
                            </td>
                        </tr>
                       <!--  <tr>
                            <th width="100" align="right">昵称：</th>
                            <td class="pull-left"><input type="text" name="name" value="bma5772872" class="text" style="width:200px" /></td>
                        </tr>
                        <tr>
                            <th width="100" align="right">真实姓名：</th>
                            <td class="pull-left"><input type="text" name="realName" value="" class="text" style="width:200px" /></td>
                        </tr> -->
                        <tr>
                            <th width="100" align="right">性别：</th>
                            <td class="pull-left">
                                <label class="radio" style="display:inline-block; margin-left:25px;"><input type="radio" name="sex" value="男" checked="checked"/>男</label>
                             &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label class="radio" style="display:inline-block; margin-left:20px;"><input type="radio" name="sex" value="女" />女</label>
                             
                          </td>
                        </tr>
                        <tr>
                            <th width="100" align="right" >电话号码：</th>
                            <td class="pull-left"><input type="text" name="phone" value="${ sessionScope.user.phone}" class="text" style="width:200px" /></td>
                        </tr>
                        <tr>
                            <th width="100" align="right">电子邮箱：</th>
                            <td class="pull-left"><input type="text"  name="email" value="${sessionScope.user.email }" class="text" style="width:200px" /></td>
                        </tr>
                      
                        <tr>
                            <th width="100" align="right">详细地址：</th>
                            <td class="pull-left"><input type="text"  name="address" value="${sessionScope.user.address }" class="text" /></td>
                        </tr>

                        <tr>
                            <th width="100" align="right">&nbsp;</th>
                            <td class="pull-right" ><input type="submit" value="提交" class="btn btn-base" style="font-size:14px; padding:13px 200px;background: #FFFFFF" /></td>
                        </tr>
                        
                    <!-- <a id="submit" href="#" class="btn btn-base" style="font-size:14px; padding:13px 200px;">提交</a>  <input type="submit" value="提交" class="btn btn-base" style="font-size:14px; padding:13px 200px;background: #FFFFFF" />-->
                    </tbody>
                </table>
                </form>
            </div>
