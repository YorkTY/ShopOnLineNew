...
<link rel="stylesheet" type="text/css" href="css/personal2.css">
 ...
 <a href="#">彩宝</a> <a href="#">银饰</a> <a href="#">坦桑石</a> <a href="#">世嘉</a> <a href="#">一搏千金</a> <a href="#">荔尚</a> <a href="#">金大生</a> <a href="#">黛米</a> <a href="#">IDEAL</a><a href="#">念玉珠宝</a> <a href="#">七彩云南</a><a href="#">玉礼</a>
  ...
  <div class="ucenter container-fluid clear">
    ...
    <div class="ucenter-content">
                <div class="order-header"><p> 我的订单</p></div>
                <div class="order-body tag-box">
                    <!-- <div class="tag-header">
                        <div class="tag ">全部订单</div>
                        <div class="tag active">待付款</div>
                        <div class="tag ">待确认</div>
                        <div class="tag ">待发货</div>
                        <div class="tag ">待收货</div>
                    </div> -->

                    <div class="tag-body">
                        <table class="order-header-table" cellpadding="0" cellspacing="0" border="0" width="100%">
                          
                            <c:forEach items="${sessionScope.sorderList}" var="list" >
                            
                              <tr>
                                <th width="115">订单号${list[0].forder.id}</th>
                                <th width="115">收货人：${list[0].forder.name}</th>
                                <th width="110">金额：${list[0].forder.total}</th>
                                <th width="110" style="color:red;">已付款</th>   
                                                     
                            </tr>
                                                      
                             <c:forEach items="${list}" var="detail">
                              <tr>
                                <th width="115">产品名:${detail.name}</th>
                                <th width="115">单价：${detail.price}</th>
                                <th width="110">购买数量：${detail.number}</th>
                                                    
                            </tr>      
                                                  
                             </c:forEach>
                             <tr ><th style="background: #FFFFFF;"></th></tr>
                            </c:forEach>
                        </table>
                    </div>
                </div>
