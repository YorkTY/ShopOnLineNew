...
<link rel="stylesheet" type="text/css" href="css/personal3.css">
    ...
    <div class="_body">
        <ul class="_menu">
           ...
           <li><a href="forder_getForder.action" ><s>&gt;</s>我的订单</a></li>
            <li><a href="personal4.jsp" ><s>&gt;</s>收货地址</a></li>
     ...
     <div class="ucenter-content">
                <div class="ucenter-address">
                    <div class="address-header"><a href="#" class="btn btn-base">新增收货地址</a> 您已创建1个收货地址，最多可创建12个</div>
