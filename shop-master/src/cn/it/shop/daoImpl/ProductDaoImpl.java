...
public class ProductDaoImpl extends BaseDaoImpl<Product> implements ProductDao {
	...
	public Pager<Product> getSearchProduct( int pageNum,int pageSize,String name,int min_price,int max_price){
		...
		String hql ="FROM Product p WHERE p.commend=true AND p.open=true AND :min_price<=p.price AND :max_price>=p.price AND p.name LIKE :name ORDER BY p.date DESC  limit "+fromIndex+", "+pageSize;
		//计算总记录条数
	...
	public void deleteByIds(String ids) {
		String hql="DELETE FROM Product WHERE id = "+ids+"";
