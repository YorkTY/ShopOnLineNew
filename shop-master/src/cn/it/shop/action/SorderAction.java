...
public class SorderAction extends BaseAction<Sorder> {
	...
	public String addSorder() {
		...
		Iterator it = forder.getSorderSet().iterator();
		while (it.hasNext()) {
			Sorder customer = (Sorder) it.next();
			System.out.println(customer.getName() + "" + customer.getPrice() + number);
		}
		// System.out.println(forder.getSorderSet()+"baaaaaaaaaaaaaaaaaaaa"+number);
		return "showCar";
	    }
	}
